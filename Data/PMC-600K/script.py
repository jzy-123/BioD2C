...
parser.add_argument('--pmc_output_path', type=str, default='./pmc_articles/')
parser.add_argument('--images_output_path', type=str, default='./images/')
...
def download_func(idx):
    ...
    try:
        ...
        if args.remove_pmc and os.path.exists(output_tar_file):
