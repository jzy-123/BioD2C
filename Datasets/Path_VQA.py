...
class Pathvqa_Dataset(Dataset):
    def __init__(self,  file_path, tokenizer_path, img_dir = '',img_tokens = 32, seq_length = 512,voc_size = 32000, mode = 'Train',start = 0):
    ...
    def __getitem__(self, idx):
        ...
        ##### read image pathes #####
        img_path = self.img_root + sample['image']+".jpg"
