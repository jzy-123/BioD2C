...
import transformers
from Datasets.BIoVGQ import BioVGQ
...
class ModelArguments:
    ...
    use_queue:Optional[bool] = field(default=True)
...
@dataclass
class DataArguments:
    img_dir: str = field(default='./Data/BioVGQ/images/', metadata={"help": "Path to the training data."})
...
def main():
    ...
    print("Setup Data")
    Train_dataset = BioVGQ(data_args.img_dir, data_args.Train_data_path, data_args.tokenizer_path,
                                          img_tokens=model_args.img_token_num)
    Eval_dataset = BioVGQ(data_args.img_dir, data_args.Eval_data_path, data_args.tokenizer_path,
                                         img_tokens=model_args.img_token_num)
    ...
    training_args.run_name = run_name_root+'_stage2'
    training_args.output_dir = output_dir_root + '/stage2/'
